...
2.  Returning to the full data frame, mutate it to include a new variable that contains the 
...
3.  What proportion of the flights left from Portland? What is their most common destination? 
...
4.  Create a dataframe that contains the median and interquartile range for departure delays, grouped by carrier.
...
5.  Using the airport nearest your hometown, which day of the week and which airline seems best for 
